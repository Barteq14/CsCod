...
namespace ProjektSSIW
{
    public class Składnia
    {
        ...
        public const string zeus = "zeus";//boolean
        //funkcje
        public const string ak47 = "ak47";//ReadLine()
        public const string m4a1s = "m4a1s";//WriteLine()
        public const string m4a4 = "m4a4";//Write()
        ...
        public const string negev = "negev";//if()
    }
}
